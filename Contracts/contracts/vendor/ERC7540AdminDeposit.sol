...
// Vendored from @openzeppelin/community-contracts v0.0.1 (token/ERC20/extensions/ERC7540AdminDeposit.sol), installed from
// github:OpenZeppelin/openzeppelin-community-contracts. The upstream commit was not recorded in
// package-lock.json; sha256 of the unmodified upstream file: 239b5df48d32be7b914283e4b70bbb952a34b218eb2e00c81f764ee86f8c4b10.
// Local changes: _deposits is internal (was private).
...
abstract contract ERC7540AdminDeposit is ERC7540 {
    ...
    mapping(address controller => PendingDeposit) internal _deposits;
