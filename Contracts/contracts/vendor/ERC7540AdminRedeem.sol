...
// Vendored from @openzeppelin/community-contracts v0.0.1 (token/ERC20/extensions/ERC7540AdminRedeem.sol), installed from
// github:OpenZeppelin/openzeppelin-community-contracts. The upstream commit was not recorded in
// package-lock.json; sha256 of the unmodified upstream file: 1bb6dbf9a839efabbeb3ea810801cc199b97d8d5fb400c1a8528bcb35bd089f5.
// Local changes: _redeems is internal (was private).
...
abstract contract ERC7540AdminRedeem is ERC7540 {
    ...
    mapping(address controller => PendingRedeem) internal _redeems;
